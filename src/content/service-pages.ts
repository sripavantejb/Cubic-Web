/** Extracted from https://hazelindia.com/pages/* (Firestore `pages` collection). */
export const servicePages = {
  "housekeeping-services-in-hyderabad": {
    slug: "housekeeping-services-in-hyderabad",
    path: "/pages/housekeeping-services-in-hyderabad",
    title: "Housekeeping Services",
    visible: true,
    header: {
      eyebrow: "Clean Spaces, Better Workplaces",
      heading: "Housekeeping Services in Hyderabad",
      description: "We keep your workplace clean, hygienic, and welcoming for employees and customers.",
    },
    sections: [
      {
        type: "text",
      ...
      {
        type: "steps",
        heading: "From facility assessment to seamless operations.",
        items: [
          {
            title: "Assess Your Facility",
            text: "We understand your site, operational requirements, current challenges, and service expectations to identify the right facility management approach.",
          },
          {
            title: "Plan & Mobilize",
            text: "We build a tailored service plan, deploy trained teams, establish processes, and prepare the resources required for a smooth start.",
          },
          {
            title: "Deliver & Manage",
            text: "Our teams execute daily operations with structured supervision, preventive maintenance, quality controls, and responsive support.",
          },
          {
            title: "Monitor & Improve",
            text: "We track performance, review service outcomes, and use data and client feedback to continuously improve efficiency, quality, and facility performance.",
          },
        ],
      },
      {
        ...
        items: [
          {
            q: "How do I get started with Hazel India?",
            a: "Contact our team to discuss your facility requirements. We'll assess your needs and recommend the right solution.",
          },
          {
            q: "Can Hazel India manage multiple facility requirements?",
            a: "Yes. Hazel India can coordinate multiple facility operations through one integrated management approach.",
          },
          {
            q: "How does Hazel India maintain service quality?",
            a: "We use trained teams, structured processes, supervision, technology, and performance monitoring to maintain consistent service quality.",
          },
        ],
      },
    ],
  ...
  "landscaping-services-in-hyderabad": {
    ...
    visible: true,
    header: {
      eyebrow: "Greener Spaces, Healthier Environments",
      heading: "Landscaping Services in Hyderabad",
      description: "Create attractive, healthy, and sustainable outdoor spaces with professional landscaping and grounds maintenance designed for residential, commercial, and industrial properties.",
    },
    sections: [
      {
        type: "text",
      ...
      {
        type: "steps",
        heading: "From landscape assessment to thriving green spaces.",
        items: [
          {
            title: "Assess Your Space",
            text: "We evaluate your landscape, outdoor areas, soil conditions, existing plants, water requirements, and maintenance needs.",
          },
          {
            title: "Plan & Prepare",
            text: "We develop a practical landscaping and maintenance plan based on your property's requirements, environment, and sustainability goals.",
          },
          {
            title: "Maintain & Manage",
            text: "Our teams handle planting, pruning, lawn care, garden maintenance, grounds care, and other scheduled landscaping activities.",
          },
          {
            title: "Monitor & Improve",
            text: "We monitor plant health, water use, landscape conditions, and maintenance performance to continuously improve your green spaces.",
          },
        ],
      },
      {
        ...
        items: [
          {
            q: "What landscaping services does Hazel India provide?",
            a: "Hazel India provides landscape maintenance, native landscaping, vertical gardens, lawn and garden care, rainwater systems, and grounds management.",
          },
          {
            q: "Does Hazel India provide regular landscape maintenance?",
            a: "Yes. We provide scheduled landscaping and grounds maintenance to keep lawns, gardens, plants, and outdoor areas healthy and well-maintained.",
          },
          {
            q: "Can Hazel India provide sustainable landscaping solutions?",
            a: "Yes. Our approach includes native planting, water-conscious practices, rainwater systems, and sustainable landscape management.",
          },
        ],
      },
    ],
  ...
  "mechanical-electrical-plumbing-services-in-hyderabad": {
    slug: "mechanical-electrical-plumbing-services-in-hyderabad",
    path: "/pages/mechanical-electrical-plumbing-services-in-hyderabad",
    title: "MEP Services",
    visible: true,
    header: {
    ...
    sections: [
      ...
      {
        type: "steps",
        heading: "From facility assessment to reliable MEP operations.",
        items: [
          {
            title: "Assess Your Systems",
            text: "We evaluate your HVAC, electrical, plumbing, machinery, and other technical systems to understand their condition and maintenance requirements.",
          },
          {
            title: "Plan & Mobilize",
            text: "We create a structured maintenance plan, schedule preventive servicing, and deploy trained technical personnel based on your facility requirements.",
          },
          {
            title: "Maintain & Manage",
            text: "Our teams perform scheduled maintenance, inspections, repairs, and technical support to keep critical systems operating reliably.",
          },
          {
            title: "Monitor & Improve",
            text: "We track system performance, identify recurring issues, and use maintenance insights to improve reliability, efficiency, and long-term equipment performance.",
          },
        ],
      },
      {
        ...
        items: [
          {
            q: "What MEP services does Hazel India provide?",
            a: "Hazel India provides HVAC, electrical, plumbing, machinery maintenance, water treatment, and predictive maintenance services.",
          },
          {
            q: "Does Hazel India provide preventive MEP maintenance?",
            a: "Yes. We use planned inspections, servicing, and predictive maintenance practices to identify potential issues before they lead to major breakdowns.",
          },
          {
            q: "Which facilities can use Hazel India's MEP services?",
            a: "Our MEP services are suitable for offices, IT parks, factories, warehouses, laboratories, residential communities, and other facilities.",
          },
        ],
      },
    ],
  ...
  "pest-control-services-in-hyderabad": {
    slug: "pest-control-services-in-hyderabad",
    path: "/pages/pest-control-services-in-hyderabad",
    title: "Pest Control Services",
    visible: true,
    header: {
      eyebrow: "Safer Spaces, Better Protection",
      heading: "Pest Control in Hyderabad",
      description: "Protect your property from unwanted pests with professional pest control solutions designed to maintain clean, hygienic, and healthy environments.",
    },
    sections: [
      {
        type: "text",
      ...
      {
        type: "steps",
        heading: "From inspection to ongoing pest protection.",
        items: [
          {
            title: "Inspect",
            text: "We assess your property, identify pest activity, and determine potential entry points and risk areas.",
          },
          {
            title: "Plan",
            text: "We develop a pest management plan based on the pest type, facility conditions, treatment requirements, and operating schedule.",
          },
          {
            title: "Treat",
            text: "Our trained teams carry out the appropriate treatment using professionally managed pest control methods.",
          },
          {
            title: "Monitor & Prevent",
            text: "We monitor pest activity, review treatment results, and recommend preventive measures to reduce recurring problems.",
          },
        ],
      },
      {
        ...
        items: [
          {
            q: "What pests does Hazel India control?",
            a: "We provide pest management for common pests, including cockroaches, rodents, ants, mosquitoes, and other property-related pest issues.",
          },
          {
            q: "Does Hazel India provide regular pest control?",
            a: "Yes. We can provide scheduled pest management and preventive inspections based on your property's requirements.",
          },
          {
            q: "Is pest control suitable for offices and commercial facilities?",
            a: "Yes. Our pest control services can be planned for offices, factories, warehouses, residential communities, laboratories, and other facilities with minimal operational disruption.",
          },
        ],
      },
    ],
  ...
  "logistics-services-in-hyderabad": {
    slug: "logistics-services-in-hyderabad",
    path: "/pages/logistics-services-in-hyderabad",
    title: "Logistics Services",
    visible: true,
    header: {
      eyebrow: "Smarter Movement, Smoother Operations",
      heading: "Logistics Services in Hyderabad",
      description: "Keep materials, documents, and deliveries moving efficiently with organized logistics support designed to improve coordination, productivity, and day-to-day facility operations.",
    },
    sections: [
      {
        type: "text",
      ...
      {
        type: "steps",
        heading: "From receiving to efficient movement.",
        items: [
          {
            title: "Assess",
            text: "We understand your facility, material flow, movement requirements, delivery schedules, and operational challenges.",
          },
          {
            title: "Plan & Coordinate",
            text: "We establish workflows, assign responsibilities, and organize manpower and resources around your logistics requirements.",
          },
          {
            title: "Move & Manage",
            text: "Our trained teams handle receiving, material movement, loading, unloading, internal distribution, and dispatch support.",
          },
          {
            title: "Monitor & Improve",
            text: "We track logistics activities, identify bottlenecks, and improve workflows to increase efficiency and reduce operational delays.",
          },
        ],
      },
      {
        ...
        items: [
          {
            q: "What do Hazel India's logistics services include?",
            a: "Our logistics support includes material handling, internal movement, receiving, dispatch, loading and unloading, inventory movement, and delivery coordination.",
          },
          {
            q: "Can logistics services be customized?",
            a: "Yes. We tailor logistics support based on your facility, material flow, manpower requirements, operating hours, and workflow.",
          },
          {
            q: "Can logistics be integrated with other facility services?",
            a: "Yes. Logistics can be combined with housekeeping, mailroom, concierge, MEP, security, and other facility management services.",
          },
        ],
      },
    ],
  ...
  "ifm-services": {
    ...
    sections: [
      ...
      {
        type: "cards",
        heading: "Facility Management for Different Properties",
      ...
      {
        type: "steps",
        heading: "From your first call to a seamlessly managed facility.",
        items: [
          {
            title: "Facility Assessment",
            text: "We assess your facility, understand your operational requirements, and identify the services needed to create a reliable and efficient management plan.",
          },
          {
            title: "Smart Setup",
            text: "We build a customized facility management plan, deploy trained teams, and establish the processes, schedules, and standards required for your site.",
          },
          {
            title: "Integrated Delivery",
            text: "Our teams coordinate housekeeping, maintenance, security, landscaping, logistics, concierge, and other facility services through one integrated management system.",
          },
          {
            title: "Monitor & Improve",
            text: "We regularly monitor service quality, performance, and compliance to identify improvements and ensure your facility continues to operate safely, efficiently, and smoothly.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          {
            q: "Why choose integrated facility management?",
            a: "It brings multiple facility services under one management system, improving coordination, accountability, service consistency, and operational efficiency.",
          },
          {
            q: "Can Hazel India handle all facility services under one contract?",
            a: "Yes. Hazel India can coordinate multiple services through a single facility management partner, reducing the need to manage separate service providers.",
          },
          {
            q: "How does Hazel India ensure consistent service quality?",
            a: "We use trained teams, defined processes, on-site supervision, technology, performance monitoring, and regular service reviews.",
          },
        ],
      },
    ],
