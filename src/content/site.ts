...
export const ifmGroup = {
  ...
  portraits: [
    ...
    },
    {
      label: "Security",
      href: "/pages/security-services-in-hyderabad",
      image: "/images/services/security-control-room.jpg",
      alt: "Hazel India security officers monitoring CCTV feeds and logging checks in a site control room",
    },
    {
      label: "MEP Services",
      href: "/pages/mechanical-electrical-plumbing-services-in-hyderabad",
  ...
  pains: [
    {
      ...
      image: "/images/problem-no-proof.jpg",
      alt: "Wet-floor caution sign on an empty corridor — cleaning with nothing to show it was done",
    },
    {
      icon: "Wrench",
      title: "Reactive maintenance",
      text: "Breakdowns show up as emergencies, not warnings.",
      image: "/images/problem-pipe-leak.jpg",
      alt: "Water dripping from a worn pipe joint — a small fault left unchecked until it becomes an emergency",
    },
    {
      icon: "TrendingDown",
      title: "No sustainability data",
      text: "ESG reporting means chasing five vendors for numbers.",
      image: "/images/problem-energy-meters.jpg",
      alt: "Wall of separate electricity meters — sustainability numbers scattered across sources",
    },
    {
      icon: "RefreshCw",
      title: "Staff churn",
      text: "A new, untrained team every few months.",
      image: "/images/problem-now-hiring.jpg",
      alt: "\"Now Hiring\" sign in a window — the constant turnover of untrained facility staff",
    },
  ],
  transition:
